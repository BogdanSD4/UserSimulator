...
{
	public class TypeActionCollection : TypeCommand
	{
		public TypeActionCollection(Control parent) : base(parent)
		{
		...
		public override void Result()
		{
			...
			BasePreferance preferance = new ActionControllerPreferance(fileName, "." + extension)
			{
				Name = string.IsNullOrEmpty(name)? fileName : name,
				Type = Text,
			};

			var command = new ActionCollection(preferance);
